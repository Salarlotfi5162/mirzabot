...
⚠️ حجم بر حسب مگابایت است.", $backadmin, 'HTML');
    ...
    sendmessage($from_id, "📌 شناسه اینباندی که می خواهید کانفیگ از آن ساخته شود را ارسال نمایید. شناسه اینباند یک عدد چند رقمی است که در پنل در صفحه اینباند ها ستون id نوشته شده است.
💡 **نکته:** برای ساخت کاربر روی چند اینباند به صورت همزمان، شناسه‌ها را با کاما جدا کنید (مثال: `1,2,5`).
...
📆 تاریخ خرید :  {$paymentUser['time']}";
    ...
    sendmessage($from_id, "📌 در صورتی که پنل مرزبان یا مرزنشین هستید یک نام کاربری کانفیگ از پنل کپی و ارسال نمایید در غیراینصورت برای پنل های ثنایی و علیرضا شناسه اینباند را ارسال نمایید (برای ثبت چند اینباند، با کاما جدا کنید مثل: `1,2,3`)", $backadmin, 'HTML');
